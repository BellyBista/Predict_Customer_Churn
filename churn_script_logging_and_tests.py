...
def test_eda():
    ...
    # Assert if `churn.jpg` is created
    try:
        assert os.path.isfile("./images/eda/Churn.jpg") is True
        logging.info('File %s was found', 'Churn.jpg')
    except AssertionError as err:
        logging.error('Not such file on disk')
        raise err

    # Assert if `customer_age.jpg` is created
    try:
        assert os.path.isfile("./images/eda/Customer_Age.jpg") is True
        logging.info('File %s was found', 'Customer_Age.jpg')
    except AssertionError as err:
        logging.error('Not such file on disk')
        raise err

    # Assert if `marital_status.jpg` is created
    try:
        assert os.path.isfile("./images/eda/Marital_Status.jpg") is True
        logging.info('File %s was found', 'Marital_Status.jpg')
    except AssertionError as err:
        logging.error('Not such file on disk')
        raise err

    # Assert if `total_transaction.jpg` is created
    try:
        assert os.path.isfile("./images/eda/Total_Trans_Ct.jpg") is True
        logging.info('File %s was found', 'Total_Trans_Ct.jpg')
    except AssertionError as err:
        logging.error('Not such file on disk')
        raise err
    ...
    try:
        ...
        logging.info('File %s was found', 'Heatmap.jpg')
    except AssertionError as err:
        logging.error('Not such file on disk')
        raise err
